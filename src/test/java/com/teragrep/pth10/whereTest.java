...
public class whereTest {
	...
	public void parseWhereTest() throws Exception {
		...
		e = "SELECT * FROM ( SELECT _time,count(_raw) AS count FROM `temporaryDPLView` WHERE index LIKE \"cinnamon\" AND _time >= from_unixtime("+indexEarliestEpoch+") GROUP BY _time ) WHERE count > 70";
	...
	/**
	 * <!-- index = cinnamon _index_earliest="04/16/2020:10:25:40" | chart count(_raw) as count by _time | where  count > 70 -->
	 * <root>
	 *  <search root=true>
	 *    <logicalStatement>
	 *       <AND>
	 *          <index operation="EQUALS" value="cinnamon" />
	 ...
	 * val df = spark.readStream.load().option("query","<AND><index operation=\"EQUALS\" value=\"cinnamon\" /><index_earliest operation=\"GE\" value=\"1587021940\" /></AND>")
	 ...
	 *
	 * Same using single
	 * spark.readStream.load().option("query","<AND><index operation=\"EQUALS\" value=\"cinnamon\" /><index_earliest operation=\"GE\" value=\"1587021940\" /></AND>").groupBy(col("`_time`")).agg(functions.count(col("`_raw`")).as("`count`")).where(col("`_raw`").gt(70));
	...
	public void logicalOrWhereTest() throws Exception {
		...
		e = "SELECT * FROM ( SELECT _time,count(_raw) AS cnt FROM `temporaryDPLView` WHERE index LIKE \"cinnamon\" AND _time >= from_unixtime("+indexEarliestEpoch5+") GROUP BY _time ) WHERE cnt > 70 OR cnt < 75";
		result = utils.getQueryAnalysis(q);
		assertEquals(e,result, q);
	}
	...
	public void logicalAndWhereTest() throws Exception {
		...
		e = "SELECT * FROM ( SELECT _time,count(_raw) AS cnt FROM `temporaryDPLView` WHERE index LIKE \"cinnamon\" AND _time >= from_unixtime("+indexEarliestEpoch4+") GROUP BY _time ) WHERE cnt > 70 AND cnt < 75";
		result = utils.getQueryAnalysis(q);
		assertEquals(e,result, q);
	}
	...
	public void logicalAndOrWhereTest() throws Exception {
		...
		e = "SELECT * FROM ( SELECT _time,count(_raw) AS cnt FROM `temporaryDPLView` WHERE index LIKE \"cinnamon\" AND _time >= from_unixtime("+indexEarliestEpoch6+") GROUP BY _time ) WHERE cnt > 70 AND cnt < 75 OR cnt != 72";
		result = utils.getQueryAnalysis(q);
		assertEquals(e,result, q);
	}
	...
	public void chainedTransformWhereTest() throws Exception {
		...
		e = "SELECT * FROM ( SELECT * FROM ( SELECT _time,count(_raw) AS cnt FROM `temporaryDPLView` WHERE index LIKE \"cinnamon\" AND _time >= from_unixtime("+indexEarliestEpoch2+") GROUP BY _time ) WHERE cnt > 70 ) WHERE cnt < 75";
		result = utils.getQueryAnalysis(q);
		assertEquals(e,result, q);
	}
	...
	public void logicalWhereTest() throws Exception {
		...
		e = "SELECT * FROM ( SELECT _time,count(_raw) AS cnt FROM `temporaryDPLView` WHERE index LIKE \"cinnamon\" AND _time >= from_unixtime("+indexEarliestEpoch8+") GROUP BY _time ) WHERE ( cnt > 70 AND cnt < 75 ) OR ( cnt > 30 AND cnt < 40 )";
		result = utils.getQueryAnalysis(q);
		assertEquals(e,result, q);
	}
	...
	public void complexWhereTest() throws Exception {
		...
		long indexEarliestEpoch = new DefaultTimeFormat().getEpoch("04/16/2020:10:25:40");
		e = "SELECT * FROM ( SELECT _time,count(_raw) AS cnt FROM `temporaryDPLView` WHERE index LIKE \"cinnamon\" AND _time >= from_unixtime("+indexEarliestEpoch+") GROUP BY _time ) WHERE ( cnt > 70 AND cnt < 75 ) OR ( cnt > 30 AND cnt < 40 AND cnt != 35 OR cnt = 65 )";
		result = utils.getQueryAnalysis(q);
		assertEquals(e,result, q);
	}
	...
	public void symbolTableTest() throws Exception {
		...
		long indexEarliestEpoch = new DPLTimeFormat("MM/dd/yyyy:HH:mm:ss").getEpoch("04/16/2020:10:25:40");
		e = "SELECT * FROM ( SELECT * FROM ( SELECT _time,count(_raw) AS __count_UUID FROM `temporaryDPLView` WHERE index LIKE \"cinnamon\" AND _time >= from_unixtime("+indexEarliestEpoch+") GROUP BY _time ) WHERE __count_UUID > 70 ) WHERE __count_UUID < 75";
		result = utils.getQueryAnalysis(q);
	...
	public void defaultCountWithLogicalOperationsTest() throws Exception {
		...
		long indexEarliestEpoch = new DPLTimeFormat("MM/dd/yyyy:HH:mm:ss").getEpoch("04/16/2020:10:25:40");
		e = "SELECT * FROM ( SELECT _time,count(_raw) AS `count(_raw)` FROM `temporaryDPLView` WHERE index LIKE \"cinnamon\" AND _time >= from_unixtime("+indexEarliestEpoch+") GROUP BY _time ) WHERE 'count(_raw)' > 71 AND 'count(_raw)' < 75 OR 'count(_raw)' != 72";
		result = utils.getQueryAnalysis(q);
		assertEquals(e,result, q);
	}
