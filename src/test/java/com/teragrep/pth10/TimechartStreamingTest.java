 ...
 *
 */
// all disabled because of rollback
...
public class TimechartStreamingTest {
    ...
    public void timechartStreamingTest_1() throws StreamingQueryException, InterruptedException {
    ...
    @Test
    @EnabledIfSystemProperty(named="runSparkTest", matches="true")
    public void timechartStreamingTest_1b() throws StreamingQueryException, InterruptedException {
        performStreamingDPLTest(
    ...
    @Test
    @EnabledIfSystemProperty(named="runSparkTest", matches="true")
    public void timechartStreamingTest_2() throws StreamingQueryException, InterruptedException {
        performStreamingDPLTest(
    ...
    @Test
    @EnabledIfSystemProperty(named="runSparkTest", matches="true")
    public void timechartStreamingTest_3() throws StreamingQueryException, InterruptedException {
        performStreamingDPLTest(
    ...
    @Test
    @EnabledIfSystemProperty(named="runSparkTest", matches="true")
    public void timechartStreamingTest_4() throws StreamingQueryException, InterruptedException {
        performStreamingDPLTest(
    ...
    private Dataset<Row> performDPLQuery(String query, String expectedColumns, Consumer<Dataset<Row>> assertConsumer) {
        ...
        LOGGER.debug("Parse tree for query: " + query);
