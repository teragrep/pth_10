...
public class RegexTransformationTest {
    ...
    void setUp() {
        sparkSession = SparkSession.builder()
                ...
                .config("checkpointLocation","/tmp/pth_10/test/regex/checkpoints/" + UUID.randomUUID() + "/")
                .getOrCreate();
    ...
    public void regexTest1() throws StreamingQueryException, InterruptedException {
    ...
    @Test
	@EnabledIfSystemProperty(named="runSparkTest", matches="true")
    public void regexTest2() throws StreamingQueryException, InterruptedException {
        performStreamingDPLTest(
                "index=index_A | regex _raw = \"data data\"",
                null, //"[_time, _time2]",
                ds -> {
    ...
    @Test
	@EnabledIfSystemProperty(named="runSparkTest", matches="true")
    public void regexTest3() throws StreamingQueryException, InterruptedException {
        performStreamingDPLTest(
    ...
    private void performStreamingDPLTest(String query, String expectedColumns, Consumer<Dataset<Row>> assertConsumer) throws StreamingQueryException, InterruptedException {
        ...
        final String nameOfSourceStream = "pth10_regex_test_src";
