...
public class EventstatsTransformationTest {
    ...
    void setUp() {
        sparkSession = SparkSession.builder()
                ...
                .config("checkpointLocation","/tmp/pth_10/test/eventstats/checkpoints/" + UUID.randomUUID() + "/")
                .getOrCreate();
    ...
    // ----------------------------------------
    @Test
	@EnabledIfSystemProperty(named="runSparkTest", matches="true") // Standard eventstats, without wildcards in WITH-clause
    public void eventstats_test_NoByClause() throws StreamingQueryException, InterruptedException {
    ...
    @Test
	@EnabledIfSystemProperty(named="runSparkTest", matches="true") // Standard eventstats, without wildcards in WITH-clause
    public void eventstats_test_WithByClause() throws StreamingQueryException, InterruptedException {
        performStreamingDPLTest(
    ...
    @Test
	@EnabledIfSystemProperty(named="runSparkTest", matches="true") // count with implied wildcard
    public void eventstats_test_count() throws StreamingQueryException, InterruptedException {
        performStreamingDPLTest(
    ...
    @Test
	@EnabledIfSystemProperty(named="runSparkTest", matches="true") // multiple aggregation functions
    public void eventstats_test_multi() throws StreamingQueryException, InterruptedException {
        performStreamingDPLTest(
    ...
    private void performStreamingDPLTest(String query, String expectedColumns, Consumer<Dataset<Row>> assertConsumer) throws StreamingQueryException, InterruptedException {
        ...
        final String nameOfSourceStream = "pth10_eventstats_test_src";
