...
public class SyslogStreamTest {
    ...
    void setUp() {
        sparkSession = SparkSession.builder()
                ...
                .config("checkpointLocation","/tmp/pth_10/test/syslog/checkpoints/" + UUID.randomUUID() + "/")
                .getOrCreate();
    ...
    public void syslogStream_test_2() throws StreamingQueryException, InterruptedException, IOException {
        assertThrows(StreamingQueryException.class, () -> performStreamingDPLTest(
    ...
    private void performStreamingDPLTest(String query, String expectedColumns, Consumer<Dataset<Row>> assertConsumer) {
        ...
        final String nameOfSourceStream = "pth10_syslog_test_src";
    ...
    private Dataset<Row> performDPLQuery(String query, String expectedColumns, Consumer<Dataset<Row>> assertConsumer) {
        ...
        visitor.getCatalystContext().flush();
