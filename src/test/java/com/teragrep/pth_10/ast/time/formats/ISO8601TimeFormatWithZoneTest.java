...
public final class ISO8601TimeFormatWithZoneTest {
    ...
    public void testAtZone() {
        ...
        DPLTimeFormat format = new ISO8601TimeFormatWithZone(utcZone).atZone(zone);
        DPLTimestamp timestamp = format.from("2025-09-10T12:34:56+02:00");
        ZonedDateTime zonedDateTime = timestamp.zonedDateTime();
    ...
    public void testContract() {
        EqualsVerifier
                .forClass(ISO8601TimeFormatWithZone.class)
