...
public final class ISO8601TimeFormatWithZoneAndMillisTest {

    private final ZoneId utcZone = ZoneId.of("UTC");

    @Test
    public void testValidValue() {
        final DPLTimeFormat format = new ISO8601TimeFormatWithZoneAndMillis(utcZone);
        final DPLTimestamp timestamp = format.from("2025-09-10T12:34:56.123+02:00");
    ...
    public void testAtZone() {
        ...
        DPLTimeFormat format = new ISO8601TimeFormatWithZoneAndMillis(utcZone).atZone(zone);
        DPLTimestamp timestamp = format.from("2025-09-10T12:34:56.123+02:00");
        ZonedDateTime zonedDateTime = timestamp.zonedDateTime();
    ...
    public void testContract() {
        EqualsVerifier
                .forClass(ISO8601TimeFormatWithZoneAndMillis.class)
