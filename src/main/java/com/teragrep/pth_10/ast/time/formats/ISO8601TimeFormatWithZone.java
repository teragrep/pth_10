...
public final class ISO8601TimeFormatWithZone implements DPLTimeFormat {

    private final Logger LOGGER = LoggerFactory.getLogger(ISO8601TimeFormatWithZone.class);
    private final String timeFormat;
    private final ZoneId zoneId;

    public ISO8601TimeFormatWithZone() {
        this("yyyy-MM-dd'T'HH:mm:ssXXX", ZoneId.systemDefault());
    }

    public ISO8601TimeFormatWithZone(final ZoneId zoneId) {
        this("yyyy-MM-dd'T'HH:mm:ssXXX", zoneId);
    }

    private ISO8601TimeFormatWithZone(final String timeFormat, final ZoneId zoneId) {
    ...
    @Override
    public DPLTimeFormat atZone(ZoneId zoneId) {
        return new ISO8601TimeFormatWithZone(timeFormat, zoneId);
    }
