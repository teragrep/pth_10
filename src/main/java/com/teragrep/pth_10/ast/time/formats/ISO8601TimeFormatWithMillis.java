...
public final class ISO8601TimeFormatWithMillis implements DPLTimeFormat {

    private final Logger LOGGER = LoggerFactory.getLogger(ISO8601TimeFormatWithMillis.class);
    private final String timeFormat;
    private final ZoneId zoneId;

    public ISO8601TimeFormatWithMillis() {
        this("yyyy-MM-dd'T'HH:mm:ss.SSS", ZoneId.systemDefault());
    }

    public ISO8601TimeFormatWithMillis(final ZoneId zoneId) {
        this("yyyy-MM-dd'T'HH:mm:ss.SSS", zoneId);
    }

    private ISO8601TimeFormatWithMillis(final String timeFormat, final ZoneId zoneId) {
    ...
    public DPLTimeFormat atZone(final ZoneId zoneId) {
        return new ISO8601TimeFormatWithMillis(timeFormat, zoneId);
    }
