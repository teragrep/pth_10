...
import com.teragrep.pth_10.ast.commands.transformstatement.accum.AccumTransformation;
import com.teragrep.pth_10.ast.commands.transformstatement.rex4j.Rex4jTransformation;
        ...
        if (leftTree != null) {
            ...
            if (left != null) {
                ...
                if (rightTree != null) {
                    ...
                    LOGGER.info("-> Right tree is NULL");
