 ...
 */
package com.teragrep.pth_10.steps.rename;
...
public abstract class AbstractRenameStep extends AbstractStep {
    ...
    public void setMapOfRenamedFields(Map<String, String> mapOfRenamedFields) {
        this.mapOfRenamedFields = mapOfRenamedFields;
    }

    public Map<String, String> getMapOfRenamedFields() {
        return mapOfRenamedFields;
    }
}
