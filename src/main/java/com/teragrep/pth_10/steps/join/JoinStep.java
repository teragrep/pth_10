 ...
 */
package com.teragrep.pth_10.steps.join;

import com.teragrep.pth_10.steps.subsearch.AbstractSubsearchStep;
...
public final class JoinStep extends AbstractJoinStep {
    ...
    public Dataset<Row> get(Dataset<Row> dataset) throws StreamingQueryException {
        if (dataset == null) {
            LOGGER.error("JoinStep was given a null dataset for query <{}>", catCtx.getQueryName());
            return null;
        }
