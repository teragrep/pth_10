...
public abstract class AbstractDplStep extends AbstractStep {

    public enum DplCommandType {
        PARSETREE
    }

    protected DplCommandType commandType = DplCommandType.PARSETREE;
    ...
    public void setGeneratedDatasource(GeneratedDatasource generatedDatasource) {
    ...
    public DplCommandType getCommandType() {
        return commandType;
    }
    ...
    public GeneratedDatasource getGeneratedDatasource() {
