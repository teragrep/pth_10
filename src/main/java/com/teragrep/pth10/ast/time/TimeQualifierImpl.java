...
public final class TimeQualifierImpl implements TimeQualifier {
    ...
    public TimeQualifierImpl(final String value, final String timeformat, final int type, final Document doc) {
        this.token = type;
        this.value = value;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        TimeQualifierImpl that = (TimeQualifierImpl) o;
