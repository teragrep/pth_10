...
/**
 * For using the DPL custom timeformat like Java's SimpleDateFormat.
 * Get a Date object with parse -function for example.
 */
public final class DPLTimeFormat {
    ...
    /**
     * Create a SimpleDateFormat object from the given DPL specific timeformat.
     * Allows all sorts of parsing and tampering with the time.
    ...
    /**
     * Parses the time string and converts it to an unic epoch long.
     * Uses the system timezone as default if timezone is not specified in the pattern (given in the constructor).
     * For setting a timezone later on (or any other operation) you will have to use createSimpleDateFormat function.
