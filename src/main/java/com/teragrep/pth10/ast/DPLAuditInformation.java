 ...
 */
public class DPLAuditInformation {

    private String query = "";
    private String reason = "";
    private String user = "";
    private String teragrepAuditPluginClassName = "";
    ...
    public void setTeragrepAuditPluginClassName(String teragrepAuditPluginClassName) {
