...
public class AggregateFunction extends DPLParserBaseVisitor<Node> {
	 ...
	 * @param buf
	 */
    public AggregateFunction(Dataset<Row> ds, List<String> buf) {
        this.doc = null;
        this.ds = ds;
	 ...
	 * @param buf
	 */
    public AggregateFunction(ProcessingStack processingPipe, List<String> buf) {
        this.doc = null;
        this.ds = null;
	...
	public Node visitAggregateFunction(DPLParser.AggregateFunctionContext ctx) {
        Node rv = AggregateFunctionEmitCatalyst(ctx);
	...
	public Node AggregateFunctionEmitCatalyst(DPLParser.AggregateFunctionContext ctx) {
        Node rv = null;
        traceBuffer.add(ctx.getChildCount() + " Aggregation function(Catalyst):" + ctx.getText());
        rv = visit(ctx.getChild(0));
        traceBuffer.add(" Aggregation function (Catalyst) rv:" + ((ColumnNode)rv).getColumn().expr().sql());
        return rv;
    }
	...
	public Node aggregateMethodCountEmitCatalyst(DPLParser.AggregateMethodCountContext ctx) {
		...
		if (columnPt != null) {
			//col = functions.count(columnPt.getText());
			col = new CountAggregator(columnPt.getText()).toColumn();
			resultColumnName = String.format("count(%s)", columnPt.getText());
		}
		else {
			//col = functions.count(ds.columns()[0]);
			col = new CountAggregator(null).toColumn();
		}
	...
	public Node aggregateMethodSumEmitCatalyst(DPLParser.AggregateMethodSumContext ctx) {
        Node rv = null;
        Column col = functions.sum(ctx.getChild(1).getText());
        traceBuffer.add("Visit AggregateMethodSum(Catalyst):" + col.expr().sql());
    ...
    public Node aggregateMethodMedianEmitCatalyst(DPLParser.AggregateMethodMedianContext ctx) {
    	...
    	traceBuffer.add("Visit AggregateMethodMedian(Catalyst):" + res.expr().sql());
    ...
    public Node aggregateMethodEstimatedDistinctErrorCountEmitCatalyst(DPLParser.AggregateMethodEstimatedDistinctErrorCountContext ctx) {
    	...
    	traceBuffer.add("Visit AggregateMethodEstimatedDistinctError(Catalyst):" + estdc_error.expr().sql());
    ...
    public Node aggregateMethodRangeEmitCatalyst(DPLParser.AggregateMethodRangeContext ctx) {
    	...
    	traceBuffer.add("Visit AggregateMethodRange(Catalyst):" + rangeCol.expr().sql());
    ...
    public Node aggregateMethodSumSquareEmitCatalyst(DPLParser.AggregateMethodSumSquareContext ctx) {
    	...
    	traceBuffer.add("Visit AggregateMethodSumSquare(Catalyst):" + colOfSumSq.expr().sql());
    ...
    public Node aggregateMethodDistinctCountEmitCatalyst(DPLParser.AggregateMethodDistinctCountContext ctx) {
    	...
    	traceBuffer.add("Visit AggregateMethodDistinctCount(Catalyst):" + col.expr().sql());
    	rv = new ColumnNode(col.as(resultColumnName));
    ...
    public Node aggregateMethodEstimatedDistinctCountEmitCatalyst(DPLParser.AggregateMethodEstimatedDistinctCountContext ctx) {
    	...
    	traceBuffer.add("Visit AggregateMethodEstimatedDistinctCount(Catalyst):" + col.expr().sql());
    ...
    public Node aggregateMethodMaxEmitCatalyst(DPLParser.AggregateMethodMaxContext ctx) {
		...
		traceBuffer.add("visitAggregateMethodMax(Catalyst):" + col.expr().sql());
    ...
    public Node aggregateMethodMinEmitCatalyst(DPLParser.AggregateMethodMinContext ctx) {
    	...
    	traceBuffer.add("visitAggregateMethodMin(Catalyst):" + col.expr().sql());
    	rv = new ColumnNode(col.as(resultColName));
    ...
    public Node aggregateMethodVarianceEmitCatalyst(DPLParser.AggregateMethodVarianceContext ctx) {
    	...
    	traceBuffer.add("visitAggregateMethodVariance(Catalyst):" + col.expr().sql());
    	rv = new ColumnNode(col.as(resultColumnName));
    ...
    public Node aggregateMethodStandardDeviationEmitCatalyst(DPLParser.AggregateMethodStandardDeviationContext ctx) {
    	...
    	traceBuffer.add("visitAggregateMethodStandardDeviation(Catalyst):" + col.expr().sql());
    	rv = new ColumnNode(col.as(resultColumnName));
    	return rv;
    }
    ...
    public Node aggregateMethodAvgEmitCatalyst(DPLParser.AggregateMethodAvgContext ctx) {
    	...
    	traceBuffer.add("Visit AggregateMethodAvg(Catalyst):" + col.expr().sql());
    ...
    /**
     * <pre>aggregateMethodPercentileVariable
    ...
    public Node aggregateMethodPercentileVariableEmitCatalyst(DPLParser.AggregateMethodPercentileVariableContext ctx) {
    	...
    	LOGGER.info("perc; X = " + xThPercentileArg);
